    ...
    return (
      <html lang="en-US">
        <Head>
          ...
          <meta name='apple-mobile-web-app-title' content='Leonardo Maldonado' />
          ...
          <meta name='twitter:image' content='https://leonardomso.com/static/icons/android-chrome-192x192.png' />
          ...
          <meta property='og:image' content='https://leonardomso.com/static/icons/apple-touch-icon.png' />
