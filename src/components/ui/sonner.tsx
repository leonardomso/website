		...
		<Sonner
			...
			toastOptions={{
				classNames: {
					...
					actionButton:
						"data-button:group-[.toast]:h-8 data-button:group-[.toast]:rounded-custom data-button:group-[.toast]:px-3 data-button:group-[.toast]:text-xs data-button:group-[.toast]:font-medium",
					cancelButton:
						"data-button:group-[.toast]:h-8 data-button:group-[.toast]:rounded-custom data-button:group-[.toast]:px-3 data-button:group-[.toast]:text-xs data-button:group-[.toast]:font-medium",
				},
			}}
